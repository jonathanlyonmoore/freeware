...
#@version $Id: acinclude.m4,v 1.16 2005/02/24 15:12:05 cristy Exp $
#
...
if test "$ac_cv_cxx_ios_binary" = no; then
  AC_DEFINE(MISSING_STD_IOS_BINARY,,[define if the compiler supports ios::binary])
fi
rm -rf SunWS_cache
])
...
dnl
dnl @version $Id: acinclude.m4,v 1.16 2005/02/24 15:12:05 cristy Exp $
