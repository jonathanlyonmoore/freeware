...
$library/create libMagick.olb -
  animate, annotate, attribute, blob, cache, cache-view, client, coder, -
  ...
  layer, list, locale, log, magic, magick, memory, module, -
  ...
  type, utility, version, vms, widget, xwindow, statistic, prepress, -
   xml-tree, -
