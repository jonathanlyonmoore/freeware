...
#define JP2EncodeImage  PrependMagickMethod(JP2EncodeImage)
...
#define ParseCharacterContent  PrependMagickMethod(ParseCharacterContent)
...
#define RemoveTagFromXMLTree  PrependMagickMethod(RemoveTagFromXMLTree)
...
#define SyncImageCache  PrependMagickMethod(SyncImageCache)
