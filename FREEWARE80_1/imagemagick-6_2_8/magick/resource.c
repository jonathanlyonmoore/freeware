...
MagickExport void InitializeMagickResources(void)
{
  ...
  */
  ...
  files=getdtablesize();
#endif
  (void) SetMagickResourceLimit(FileResource,(unsigned long) Max(3*files/4,64));
